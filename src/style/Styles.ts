...
const CommonStyles = StyleSheet.create({
    ...
    heading_16_light_blue: {
        fontWeight: BOLD,
        fontSize: font_16,
        color: colors.LIGHT_BLUE,
    },
    heading_16_dark_blue: {
        fontWeight: BOLD,
        fontSize: font_16,
    ...
    paragraph_10_dark_blue: {
        fontSize: font_10,
        color: colors.DARK_BLUE,
    },
    paragraph_10_light_blue: {
        fontSize: font_10,
        color: colors.LIGHT_BLUE,
    },
    paragraph_8_white: {
    ...
    text_input: {
        flex: 1, color: colors.TEXT_COLOR, fontSize: font_14,
    },
    error: {
        color: colors.RED,
        fontSize: font_12,
